...
function kgnsallsl() { & kubectl get namespaces --all-namespaces --show-labels $args }
...
function kgnsslall() { & kubectl get namespaces --show-labels --all-namespaces $args }
...
function kgnsowideallsl() { & kubectl get namespaces -o=wide --all-namespaces --show-labels $args }
...
function kgnsowideslall() { & kubectl get namespaces -o=wide --show-labels --all-namespaces $args }
...
function kgnsallowidesl() { & kubectl get namespaces --all-namespaces -o=wide --show-labels $args }
...
function kgnsallslowide() { & kubectl get namespaces --all-namespaces --show-labels -o=wide $args }
...
function kgnsslowideall() { & kubectl get namespaces --show-labels -o=wide --all-namespaces $args }
...
function kgnsallslw() { & kubectl get namespaces --all-namespaces --show-labels --watch $args }
...
function kgnsallwsl() { & kubectl get namespaces --all-namespaces --watch --show-labels $args }
...
function kgnsslallw() { & kubectl get namespaces --show-labels --all-namespaces --watch $args }
...
function kgnsslwall() { & kubectl get namespaces --show-labels --watch --all-namespaces $args }
...
function kgnswallsl() { & kubectl get namespaces --watch --all-namespaces --show-labels $args }
